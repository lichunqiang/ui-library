define("dest/cellula/0.4.1/cellula-events-debug", [ "dest/cellula/0.4.1/cellula-namespace-debug" ], function(require, exports, module) {
    /**
     * @fileOverview Cellula Framework's event definition.
     * @description: defines the Event Object
     * @namespace: Cellula
     */
    var cellula = require("dest/cellula/0.4.1/cellula-namespace-debug"), util = cellula._util, idCounter = 0, idFlagHead = "cellula_", idFlagTail = "_instance_", reg = new RegExp("^" + idFlagHead + ".*" + idFlagTail + "\\d+$");
    function _check(obj) {
