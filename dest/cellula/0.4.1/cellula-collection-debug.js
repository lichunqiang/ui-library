define("dest/cellula/0.4.1/cellula-collection-debug", [ "dest/cellula/0.4.1/cellula-namespace-debug" ], function(require, exports, module) {
    /**
     * @fileOverview Cellula Framework's collection definition.
     * @description: it could be a collection of either elements or cells
     * @namespace: Cellula
     */
    var cellula = require("dest/cellula/0.4.1/cellula-namespace-debug"), util = cellula._util;
