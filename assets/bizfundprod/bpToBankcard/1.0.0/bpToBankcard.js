define("bizfundprod/bpToBankcard/1.0.0/bpToBankcard", [ "cellula/0.4.1/cellula", "cellula/0.4.1/cellula-namespace", "cellula/0.4.1/cellula-class", "cellula/0.4.1/cellula-util", "cellula/0.4.1/cellula-events", "cellula/0.4.1/cellula-cell", "cellula/0.4.1/cellula-element", "cellula/0.4.1/cellula-collection", "fdp/1.0.0/fdp", "fdp/1.0.0/fdp-namespace", "fdp/1.0.0/fdp-formItem", "$", "fdp/1.0.0/fdp-form", "fdp/1.0.0/fdp-table", "fdp/1.0.0/fdp-paginator", "select/1.0.0/select", "select/1.0.0/selectSkin.css", "accountswitcher/1.0.3/accountswitcher", "gallery/handlebars/1.0.2/handlebars", "arale/popup/1.1.5/popup", "arale/overlay/1.1.3/overlay", "arale/position/1.0.1/position", "arale/iframe-shim/1.0.2/iframe-shim", "arale/widget/1.1.1/widget", "arale/base/1.1.1/base", "arale/class/1.1.0/class", "arale/events/1.1.0/events", "alipay/deleter/1.0.0/deleter", "gallery/placeholders/3.0.2/placeholders", "tinyscrollbar/1.0.0/tinyscrollbar", "tinyscrollbar/1.0.0/tinyscrollbar.css", "accountswitcher/1.0.3/accountswitcher.css", "money/1.0.0/money" ], function(require, exports, module) {
    var Cellula = require("cellula/0.4.1/cellula");
    var FDP = require("fdp/1.0.0/fdp");
    var Select = require("select/1.0.0/select");
    var $ = require("$");
    var AccountSwitcher = require("accountswitcher/1.0.3/accountswitcher");
    var Money = require("money/1.0.0/money");
    ...
    var UploadFile = new Class("UploadFile", {
        ...
        rule: {
            availableFileType: function() {
                var allow = [ ".csv", ".xls" ], extension = /\.[^\.]+$/.exec(this.element.value);
                if (!extension) {
