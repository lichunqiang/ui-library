define("assets/js/common/cellula/0.4.1/cellula-cell", [ "assets/js/common/cellula/0.4.1/cellula-namespace" ], function(require, exports, module) {
    /**
     * @fileOverview Cellula Framework's cell definition.
     * @description: defines cell
     * @namespace: Cellula
     */
    var cellula = require("assets/js/common/cellula/0.4.1/cellula-namespace"), util = cellula._util;
...
define("assets/js/common/cellula/0.4.1/cellula-class", [ "assets/js/common/cellula/0.4.1/cellula-namespace" ], function(require, exports, module) {
    var cellula = require("assets/js/common/cellula/0.4.1/cellula-namespace");
    /**
...
define("assets/js/common/cellula/0.4.1/cellula-collection", [ "assets/js/common/cellula/0.4.1/cellula-namespace" ], function(require, exports, module) {
    /**
...
define("assets/js/common/cellula/0.4.1/cellula-element", [ "assets/js/common/cellula/0.4.1/cellula-namespace" ], function(require, exports, module) {
    /**
...
define("assets/js/common/cellula/0.4.1/cellula-events", [ "assets/js/common/cellula/0.4.1/cellula-namespace" ], function(require, exports, module) {
    /**
     * @fileOverview Cellula Framework's event definition.
     * @description: defines the Event Object
     * @namespace: Cellula
     */
    var cellula = require("assets/js/common/cellula/0.4.1/cellula-namespace"), util = cellula._util, idCounter = 0, idFlagHead = "cellula_", idFlagTail = "_instance_", reg = new RegExp("^" + idFlagHead + ".*" + idFlagTail + "\\d+$");
    function _check(obj) {
...
define("assets/js/common/cellula/0.4.1/cellula-namespace", [], function(require, exports, module) {
    /**
...
define("assets/js/common/cellula/0.4.1/cellula-util", [ "assets/js/common/cellula/0.4.1/cellula-namespace" ], function(require, exports, module) {
    /**
...
define("assets/js/common/cellula/0.4.1/cellula", [ "assets/js/common/cellula/0.4.1/cellula-namespace", "assets/js/common/cellula/0.4.1/cellula-class", "assets/js/common/cellula/0.4.1/cellula-util", "assets/js/common/cellula/0.4.1/cellula-events", "assets/js/common/cellula/0.4.1/cellula-cell", "assets/js/common/cellula/0.4.1/cellula-element", "assets/js/common/cellula/0.4.1/cellula-collection" ], function(require, exports, module) {
    var _cellula = require("assets/js/common/cellula/0.4.1/cellula-namespace"), _class = require("assets/js/common/cellula/0.4.1/cellula-class"), _util = require("assets/js/common/cellula/0.4.1/cellula-util"), _events = require("assets/js/common/cellula/0.4.1/cellula-events"), _cell = require("assets/js/common/cellula/0.4.1/cellula-cell"), _element = require("assets/js/common/cellula/0.4.1/cellula-element"), _collection = require("assets/js/common/cellula/0.4.1/cellula-collection");
