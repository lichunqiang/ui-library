define("assets/js/itemList/0.1.0/itemList", [ "assets/js/common/cellula/0.4.1/cellula", "assets/js/common/cellula/0.4.1/cellula-namespace", "assets/js/common/cellula/0.4.1/cellula-class", "assets/js/common/cellula/0.4.1/cellula-util", "assets/js/common/cellula/0.4.1/cellula-events", "assets/js/common/cellula/0.4.1/cellula-cell", "assets/js/common/cellula/0.4.1/cellula-element", "assets/js/common/cellula/0.4.1/cellula-collection" ], function(require, exports, module) {
    var c = require("assets/js/common/cellula/0.4.1/cellula");
    ...
    var ItemList = new Class("ItemList", {
        ...
        addItem: function(item) {
            if (!item) item = new this.itemType({
                conf: this.conf
            });
    ...
    var tpl = '<a href="javascript:;" class="ui-button ui-button-sorange item-del">' + '<span class="ui-button-text">Del</span>' + "</a>" + '<a href="javascript:;" class="ui-button ui-button-sblue item-edit">' + '<span class="ui-button-text">edit</span>' + "</a>";
    var MyItem = new c.Class("MyItem", {
        create: function() {
        ...
        edit: function(e) {
            ...
            // hard code for demo
            var util = c._util;
            if (util.hasClass(this.rootNode, "on-editing")) util.removeClass(this.rootNode, "on-editing"); else util.addClass(this.rootNode, "on-editing");
            util.log("edit " + this.__cid__);
            this.emit("Item:EDIT");
        }
    }).inherits(Item);
