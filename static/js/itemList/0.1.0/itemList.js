define(function(require, exports, module) {
	...
	var tpl = '<a href="javascript:;" class="ui-button ui-button-sorange item-del">' +
            '<span class="ui-button-text">Del</span>' +
            '</a>' +
            '<a href="javascript:;" class="ui-button ui-button-sblue item-edit">' +
    ...
    var MyItem = new c.Class('MyItem', {
        ...
        edit:function(e){
            ...
            if(util.hasClass(this.rootNode, 'on-editing')) util.removeClass(this.rootNode, 'on-editing');
            else util.addClass(this.rootNode, 'on-editing');
    ...
    new ItemList({key:'itemList', itemType:MyItem});
